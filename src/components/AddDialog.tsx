...
export function AddDialog({
  ...
  const options: { value: TxType; label: string; icon: typeof HandCoins; cls: string }[] = [
    { value: "debt", label: "دين", icon: HandCoins, cls: "bg-rose-600 hover:bg-rose-700" },
    { value: "payment", label: "سداد", icon: Banknote, cls: "bg-sky-600 hover:bg-sky-700" },
    { value: "pocket", label: "جيب", icon: Wallet, cls: "bg-emerald-600 hover:bg-emerald-700" },
  ];
            ...
            <div className="grid grid-cols-3 gap-2">
              {options.map((o) => (
                <Button
                  ...
                  onClick={() => {
                    setType(o.value);
                    if (o.value === "pocket") setCustomerId(undefined);
                  }}
                >
